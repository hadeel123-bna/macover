...
<html>
  <head>
    ...
    <link rel="stylesheet" href="corbielle.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <link rel="stylesheet" href="eye.css" />
  </head>
  <body>
    <nav class="navbar navbar bg-black text-white" >
        <div class="container">
            <p class="p text-white"  ><center><u>Free delivery for purchases exceeding 200dt</center></u></p>
        </div>
      </nav>
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
              ...
              <a class="navbar-brand" href="#">
                <img src="Capture d’écran (20).png" alt="" width="50" height="50">
              </a>
      ...
      <div class="table-container">
        ...
        <?php
                  ...
                  // La requête SQL pour sélectionner id, nom, et prix
                   $requete = "SELECT id, nom, prix FROM produit";
